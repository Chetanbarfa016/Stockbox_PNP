...
//
// class Broker_Responce_Detail extends StatefulWidget {
//   String? Single_id;
//    Broker_Responce_Detail({super.key, required this.Single_id,});
//
//   @override
//   State<Broker_Responce_Detail> createState() => _Broker_Responce_DetailState(Single_id:Single_id);
// }
//
// class _Broker_Responce_DetailState extends State<Broker_Responce_Detail> {
//   String? Single_id;
//   _Broker_Responce_DetailState({
//     required this.Single_id,
// });
//
//   String? loader = "true";
//   var BrokerResponse_data =[];
//   BrokerResponse_Detail_Fun() async {
//     print("Single_id == $Single_id");
//     var data = await API.BrokerResponse_all_Detail_Api(Single_id);
//
//     if (data['status'] == true) {
...
//   }
//
//   BrokerResponse_Detail(orderid, index, borkerid) async {
...
//                                   child: Text("${BrokerResponse_data[0]['signalDetails']['tradesymbol']}",style:TextStyle(
//                                       color: Colors.black,
...
//                                   child: Text( BrokerResponse_data[0]['borkerid']=="1"?"Angel":"Aliceblue",
//                                       style:TextStyle(
//                                           color: Colors.black,
//                                           fontWeight: FontWeight.bold,
//                                           fontSize: 16))),
...
//             return Card(
//               margin:BrokerResponse_data.length==index+1?
//               const EdgeInsets.only(left: 10,right: 10,top: 20, bottom: 100):
...
//                       BrokerResponse_data[index]['status']==1?
//                       print("dattt"):
//                       BrokerResponse_Detail(BrokerResponse_data[index]['orderid'], index,BrokerResponse_data[index]['borkerid'] );
//
//
//                       if (expanded) {
...
//                           ),
//                         ):
//                         BrokerResponse_data[index]['borkerid']=="2" && BrokerResponse_data[index]['status']==1?
//                         Card(
//                           margin:const EdgeInsets.only(left: 0,right: 0),
//                           elevation: 1,
//                           shape: RoundedRectangleBorder(
...
//                     itemCount: BrokerResponse_data.length,
//                     itemBuilder: (BuildContext context, int index) {
//                       return BrokerResponse_data[0]['borkerid']==1?
//                       Card(
//                         margin:BrokerResponse_data.length == index+1?
//                         EdgeInsets.only(left: 10,right: 10,top: 10, bottom: 200):
...
//                                   ),
//                                 ):
//                                 BrokerResponse_data[index]['status']==1 &&  BrokerResponse_data[index]['data']['status']==true?
//                                 Card(
//                                   margin:const EdgeInsets.only(left: 0,right: 0),
//                                   elevation: 1,
//                                   shape: RoundedRectangleBorder(
...
//                                               Expanded(
//                                                 flex: 6,
//                                                 child: Text("${BrokerResponse_data[index]['data']['data']['price']}",
//                                                     style:TextStyle(
//                                                         color: Colors.black54,
//                                                         fontWeight: FontWeight.normal,
//                                                         fontSize: 14)),
...
//                                                 flex: 6,
//                                                 child: Text(
//                                                     "${BrokerResponse_data[index]['signalDetails']['calltype']}",
//                                                     style:TextStyle(
//                                                         color: BrokerResponse_data[index]['signalDetails']['calltype'].toUpperCase() =="BUY"?
//                                                         Colors.green:Colors.red,
//                                                         fontWeight: FontWeight.w600,
//                                                         fontSize: 14)
//                                                 ),
...
//                                               Expanded(
//                                                 flex: 6,
//                                                 child: Text("${BrokerResponse_data[index]['data'][0]['Prc']}",
//                                                     style:TextStyle(
//                                                         color: Colors.black54,
//                                                         fontWeight: FontWeight.normal,
//                                                         fontSize: 14)),
...
//             child:const Icon(Icons.arrow_back,color: Colors.black,)
//         ),
//         title:const Text("Broker Response Detail",style: TextStyle(fontSize: 19,fontWeight: FontWeight.w500,color: Colors.black),),
//       ),
//       body:loader == "false"?
//       SingleChildScrollView(
...
class _Broker_Responce_DetailState extends State<Broker_Responce_Detail> {
  ...
  BrokerResponse_Detail(orderid, index, borkerid) async {
    ...
    print("datt== ${data}");
    print("5555555555555== ${data['response']}");
    if(data['status']==true){
      setState(() {
        BrokerResponse_data[index]['data'] = data['response'];
        BrokerResponse_data[index]['status'] = 1;
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              ...
                              child: Container(
                                  margin: const EdgeInsets.only(left: 10, right: 8),
                                  child: Text("${BrokerResponse_data[0]['signalDetails']['tradesymbol']}",style:const TextStyle(
                                      color: Colors.black,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16),)),
                            ),
                            Expanded(
                              ...
                              child: Container(
                                  margin: const EdgeInsets.only(right: 10, left: 8),
                                  alignment: Alignment.centerRight,
                                  child: Text(BrokerResponse_data[0]['borkerid']=="1"?
                                  "Angel":
                                  BrokerResponse_data[0]['borkerid']=="2"?
                                  "Aliceblue":
                                  BrokerResponse_data[0]['borkerid']=="3"?
                                  "Kotak":
                                  BrokerResponse_data[0]['borkerid']=="4"?
                                  "Market Hub":
                                  BrokerResponse_data[0]['borkerid']=="5"?
                                  "Zerodha":
                                  BrokerResponse_data[0]['borkerid']=="6"?
                                  "UpStox":
                                  "Dhan",
                    ...
                    return Card(
                      ...
                      child: Theme(
                        ...
                        child: ExpansionTile(
                          ...
                          onExpansionChanged: (bool expanded) {
                            setState(() {
                              print("1111: ${BrokerResponse_data[index]['orderid']}");
                              print("2222: ${BrokerResponse_data[index]['borkerid']}");
                              print("3333: $index");
                          ...
                          children: [
                            Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                flex: 6,
                                                child: Text(
                                                    BrokerResponse_data[index]['borkerid']=="1"?
                                                    "Angel":
                                ...
                                BrokerResponse_data[index]['borkerid'].toString()=="5" && BrokerResponse_data[index]['status']==1?
                                Card(
                                  margin:const EdgeInsets.only(left: 0,right: 0),
                                  elevation: 1,
                                  shape: RoundedRectangleBorder(
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                flex: 6,
                                                child: Text("${BrokerResponse_data[index]['data']['data'][0]['order_timestamp']}",
                                                    style:const TextStyle(
                                                        color: Colors.black54,
                                                        fontWeight: FontWeight.normal,
                                                        fontSize: 14)),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                flex: 6,
                                                child: Text("${BrokerResponse_data[index]['data']['data'][0]['tradingsymbol']}",
                                                    style:const TextStyle(
                                                        color: Colors.black54,
                                                        fontWeight: FontWeight.normal,
                                                        fontSize: 14)),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                flex: 6,
                                                child: Text("${BrokerResponse_data[index]['data']['data'][0]['quantity']}",
                                                    style:const TextStyle(
                                                        color: Colors.black54,
                                                        fontWeight: FontWeight.normal,
                                                        fontSize: 14)),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                flex: 6,
                                                child: Text("${BrokerResponse_data[index]['data']['data'][0]['order_id']}",
                                                    style:const TextStyle(
                                                        color: Colors.black54,
                                                        fontWeight: FontWeight.normal,
                                                        fontSize: 14)),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                flex: 6,
                                                child:Text("${BrokerResponse_data[index]['data']['data'][0]['status'].toUpperCase()}",
                                                    style:TextStyle(
                                                        color: BrokerResponse_data[index]['data']['data'][0]['status'].toUpperCase()=="REJECTED"?
                                                        Colors.red:
                                                        Colors.green,
                                                        fontWeight: FontWeight.w600,
                                                        fontSize: 14)),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                flex: 6,
                                                child: Text("${BrokerResponse_data[index]['data']['data'][0]['status_message']==null?"":BrokerResponse_data[index]['data']['data'][0]['status_message']}",
                                                    style:const TextStyle(
                                                        color: Colors.black54,
                                                        fontWeight: FontWeight.normal,
                                                        fontSize: 14)),
