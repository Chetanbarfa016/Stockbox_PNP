...
//         ),
//         title:const Text("Stocks",style: TextStyle(fontSize: 19,fontWeight: FontWeight.w500,color: Colors.black),),
//         actions: [
//           GestureDetector(
//             onTap: (){
...
//                   colors: [Color(0xff354273), Color(0xff354273)],
//                 ),
//                 borderRadius: BorderRadius.circular(10),
//               ),
//               tabs:  <Widget>  [
...
//                                       child: Text("₹$Investment_amount",style:const TextStyle(fontSize: 15,fontWeight: FontWeight.w600),),
//                                     )
//                                   ],
//                                 ),
//
...
//                                     ),
//                                     CurrentValue!.toStringAsFixed(2)==0.00?
//                                     Container(
//                                       margin:const EdgeInsets.only(top: 2),
...
//                                                         child: Text("${Stocks_data[index]['price']}",style:const TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: ColorValues.Splash_bg_color1),),
//
//                                                       ) ,
//                                                     )
//
...
//                                                         alignment: Alignment.centerLeft,
//                                                         margin:const EdgeInsets.only(left: 8),
//                                                         child: Text("${Stocks_data[index]['weightage']} %",style:const TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: ColorValues.Splash_bg_color1),),
//                                                       ),
//                                                     )
//                                                   ],
//                                                 )
...
//                                                       Text("₹${previousPrice}",style:const TextStyle(fontWeight: FontWeight.w600,color: ColorValues.Splash_bg_color1,fontSize: 12),):
...
//                 loader=="false"?
//                 Container(
//                   child:const Center(child: CircularProgressIndicator(color: ColorValues.Splash_bg_color1,)),
//                 ) :
//                 Container(
//                   child:const Center(
...
//                                 print("2222222");
//
//                                 double valu = currentPrice_MyPortfolio * double.parse(MyPortfolio_data[index]['totalQuantity'].toString());
...
//                                                         alignment: Alignment.centerLeft,
//                                                         margin:const EdgeInsets.only(left: 8),
//                                                         child: Text("${MyPortfolio_data[index]['price']}",style:const TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: ColorValues.Splash_bg_color1),),
//
//                                                       ) ,
//                                                     )
//
...
//                                                         alignment: Alignment.centerLeft,
//                                                         margin:const EdgeInsets.only(left: 8),
//                                                         child: Text("96 %",style:const TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: ColorValues.Splash_bg_color1),),
//                                                       ),
//                                                     )
//                                                   ],
//                                                 )
...
//                                                     child: FittedBox(
//                                                       fit: BoxFit.scaleDown,
//                                                       child: currentPrice_MyPortfolio==0.0||currentPrice_MyPortfolio==0||currentPrice_MyPortfolio==null?
//                                                       Text("₹${previousPrice_MyPortfolio}",style:const TextStyle(fontWeight: FontWeight.w600,color: ColorValues.Splash_bg_color1,fontSize: 12),):
...
//                                 "₹${InvestmentAmount_MyPortfolio!.toStringAsFixed(2)}":
//                                 "₹$Investment_amount",
//                                 style:const TextStyle(
//                                     fontSize: 12,
//                                     fontWeight: FontWeight.w400,
