...
class Basket_BrokerResponse extends StatefulWidget {
  const Basket_BrokerResponse({super.key});

  @override
  State<Basket_BrokerResponse> createState() => _Basket_BrokerResponseState();
}

class _Basket_BrokerResponseState extends State<Basket_BrokerResponse> {

  String? loader = "true";
  var BrokerResponse_data =[];
  BrokerResponse_Fun() async {
    var data = await API.Basket_BrokerResponse_Api();
  ...
  BrokerResponse_Detail_Fun(orderid, index, borkerid) async {
    var data = await API.Basket_BrokerResponse_Detail_Api(orderid, borkerid);
    if(data['status']==true){
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title:const Text("Basket Broker Response",style: TextStyle(fontSize: 19,fontWeight: FontWeight.w500,color: Colors.black),),
        ),
        body:  loader == "false"?
        ListView.builder(
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    "${BrokerResponse_data[index]['tradesymbol']}",
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Text("price : ₹${BrokerResponse_data[index]['price']}",style:const TextStyle(fontSize: 12,fontWeight: FontWeight.w600),),
