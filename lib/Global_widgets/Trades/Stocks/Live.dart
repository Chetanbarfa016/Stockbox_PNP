...
class Stock_livetrades extends StatefulWidget {
  const Stock_livetrades({Key? key}) : super(key: key);

  @override
  State<Stock_livetrades> createState() => _Stock_livetradesState();
}

class _Stock_livetradesState extends State<Stock_livetrades> {
  @override
                              ...
                              Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        margin:const EdgeInsets.only(left: 8),
                                        child: Text("( 1315.50-1335.50 )",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: ColorValues.Splash_bg_color1),),
                                      )
                                    ],
                                  ),
                              ),
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                       children: [
                        ...
                        Container(
                           ...
                           child: Text("View Chart",style: TextStyle(fontSize: 13,fontWeight: FontWeight.w600,color: ColorValues.Splash_bg_color2),),
                        ),
